...
public interface Subcat extends MutableEvent, SexpConvertible {
  ...
  /**
   * Remove the specified nonterminal from the set of required arguments
   * of this subcat frame.  It is an error to call this method after
   * {@link #empty} returns <code>true</code>.
   *
   * @param requirement the requirement that has been fulfilled and should
   * be removed from this subcat
