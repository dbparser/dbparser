...
/**
 * Specification for a <code>Subcat</code> object factory, to be used by the
 * <code>Subcats</code> static factory class.
 *
 * @see Subcats
...
public interface SubcatFactory extends Serializable {
   ...
   *             behavior is undefined if <code>list</code> contains a
   *             <code>SexpList</code> object
   */
  public Subcat get(SexpList list);

  /**
   * Provides any static initialization necessary for the {@link Subcat}
   * implementation constructed by this factory.
   *
   * @param nonterminals the complete set of nonterminals over which subcats
   *                     will be formed
   */
