 ...
 * particular Treebank.
*/
public abstract class Treebank implements Serializable {
  // constants
   ...
   * Training#hasGap(Sexp,Sexp,ArrayList)}, which is a helper method for the
   * default implementation of {@link Training#addGapInformation(Sexp)}.
   *
