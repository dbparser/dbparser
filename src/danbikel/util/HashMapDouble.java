 ...
 * when developing/debugging hash functions.  We also wanted to map
 * arbitrary objects to doubles.
 *
...
public class HashMapDouble extends AbstractMap
  ...
  public boolean containsValue(Object value) {
    if (true)
      throw new RuntimeException("warning: using containsValue on HashMapDouble instance!");
    Entry tab[] = table;

    for (int i = tab.length ; i-- > 0 ;)
      for (Entry e = tab[i] ; e != null ; e = e.next)
        if (((Double)value).doubleValue() == e.getDoubleValue())
          return true;
  ...
  public Object get(Object key) {
    if (true)
      throw new RuntimeException("warning: using get on HashMapDouble instance!");
    Entry tab[] = table;
  ...
  */
  ...
  public Object put(Object key, Object value) {
    if (true)
      throw new RuntimeException("warning: using put on HashMapDouble instance!!!");
    ...
    Entry e = new Entry(hash, key, doubleVal, tab[index]);
    tab[index] = e;
    count++;
    return null;
  }
   ...
   *	       <tt>null</tt> with the specified key.
   */
  protected void putAndRemove(Object key, double value) {
    // Makes sure the key is not already in the HashMap.
    Entry tab[] = table;
    int hash = 0;
    int index = 0;
   ...
   */
  protected void removeRandom(int idx) {
    if (count == 0)
      return;
    Entry e = table[idx];
  ...
  public Object clone() {
    try {
      HashMapDouble t = (HashMapDouble)super.clone();
  ...
  public Set keySet() {
    if (keySet == null) {
	  ...
	  public boolean remove(Object o) {
	    int oldSize = count;
	    HashMapDouble.this.remove(o);
	    return count != oldSize;
	  }
	  public void clear() {
	    HashMapDouble.this.clear();
	  }
	};
    }
    return keySet;
  ...
  private static class Entry implements Map.Entry {
    ...
    Entry(int hash, Object key, double value, Entry next) {
      this.hash = hash;
      this.key = key;
      this.value = value;
      this.next = next;
    ...
    public Object getValue() {
      if (true)
        throw new RuntimeException("warning: using getValue on HashMapDouble.Entry instance!");
	...
	return false;
      ...
      if (o instanceof HashMapDouble.Entry) {
        Entry e = (Entry)o;
  ...
  private class HashIterator implements Iterator {
    Entry[] table = HashMapDouble.this.table;
    ...
    HashIterator(int type) {
      this.type = type;
      if (type == VALUES)
        throw new RuntimeException("warning: using values iterator on HashMapDouble instance!");
    }
	...
	throw new ConcurrentModificationException();
      ...
      Entry[] tab = HashMapDouble.this.table;
