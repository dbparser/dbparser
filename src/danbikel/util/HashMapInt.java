...
public class HashMapInt<K> extends HashMapPrimitive<K>
  ...
  protected static class Entry<K> extends HashMapPrimitive.Entry<K> {
     ...
     * @return the <code>int</code> value associated with the key in this
     *         entry
     */
    ...
    /**
     * Sets the <code>int</code> value associated with the key in this
     * entry.
     *
     * @param index an ignored parameter
    ...
    /**
     * Adds the specified amount to the <code>int</code> associated with the
     * key in this entry.
     *
     * @param index  an ignored parameter
     * @param addend the amount to add to the <code>int</code> associated
