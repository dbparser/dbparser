 ...
 */
 abstract public class HashMapPrimitive<K>
   ...
   * views which are built on top of the provided entrySet view, we need the
   * set to be over Map.Entry<K,Object>.  However, we crucially use
   * covariant return types in EntryIterator<K> to have the next() method
   * return a subtype of Map.Entry<K,Object>, which is MapToPrimitive.Entry<K>.
   */
